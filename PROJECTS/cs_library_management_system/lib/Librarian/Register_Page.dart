...
class _MYREGISTERFORMState extends State<MYREGISTERFORM> {
  ...
  Future checkUsername(String user) async {
    String result = await LibrarianDBHelper.checkUsername(user);
  ...
  Future<void> insertLibrarianData(
      String firstname,
      String lastname,
      String email,
      String mobile,
    ...
    dynamic result = await LibrarianDBHelper.insertLibrarianData(data);
              ...
              children: [
                ...
                Flexible(
                  ...
                  child: TextFormField(
                    ...
                    maxLength: 8,
                    decoration: InputDecoration(
                      suffixIcon: value1 == "true" && value1.isNotEmpty
                          ? validIcon()
                          : invalidIcon(),
                      border: const OutlineInputBorder(
                          borderSide: BorderSide(
