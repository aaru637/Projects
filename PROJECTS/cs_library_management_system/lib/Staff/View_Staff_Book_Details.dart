...
class View_Staff_Book_Details extends StatefulWidget {
  final String bookname,
      ...
      checkdate,
      renewdate;
  const View_Staff_Book_Details({Key? key,
    required this.bookname,
    required this.isbnno,
    required this.edition,
    required this.publishedyear,
    required this.checkdate,
    required this.renewdate}) : super(key: key);

  @override
  State<View_Staff_Book_Details> createState() => _View_Staff_Book_DetailsState();
}

class _View_Staff_Book_DetailsState extends State<View_Staff_Book_Details> {
